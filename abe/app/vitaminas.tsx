...
export default function Medicamentos() {
  ...
  useEffect(() => {
    (async () => {
      try {
        setErrorMsg(null);
        setLoading(true);
        const products = await fetchProductsByCategory("Vitaminas", 50);
        setItems(products);
      } catch (e: any) {
  ...
  // >>> NOVO: abrir tela do produto com o id
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.topRect}>
        ...
        <Text style={styles.topTitle}>Vitaminas</Text>
        ...
        <View style={styles.iconCircle}>
          <Image source={require("../assets/images/vitaminas.png")} style={styles.sacolaIcon} />
        </View>
      </View>
