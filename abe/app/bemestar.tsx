...
export default function Medicamentos() {
  ...
  // >>> NOVO: abre a tela de produto com o id selecionado
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.topRect}>
        ...
        <Text style={styles.topTitle}>Bem-Estar</Text>
        ...
        <View style={styles.iconCircle}>
          <Image source={require("../assets/images/maos.png")} style={styles.sacolaIcon} />
        </View>
      </View>
...
const ProductCard = memo(function ProductCard({
  ...
  return (
    // <<< transformamos o card em TouchableOpacity para redirecionar ao produto
    <TouchableOpacity style={styles.card} activeOpacity={0.9} onPress={onOpen}>
      ...
      {/* Botão comprar continua funcionando independente do clique no card */}
